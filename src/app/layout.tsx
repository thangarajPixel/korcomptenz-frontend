  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" suppressHydrationWarning>
      <head>
        ...
        {/* Preload critical images for hero section on mobile */}
        <link
          rel="preload"
          as="image"
          href="https://aue2kormlworkspacetest01.blob.core.windows.net/korcomptenz/hero-mobile.webp"
          media="(max-width: 640px)"
        />
        <link
          rel="preload"
          as="image"
          href="https://aue2kormlworkspacetest01.blob.core.windows.net/korcomptenz/hero-desktop.webp"
        ...
        {/* Inline critical CSS for faster FCP - optimized for LCP, TBT, SI */}
        <style
          dangerouslySetInnerHTML={{
            __html: `html,body{margin:0;padding:0;font-family:'Outfit',system-ui,sans-serif;font-display:swap}body{background:#fff;color:#313941;overflow-x:hidden;scrollbar-gutter:stable}html.dark,html.dark body{background:#0a0a0a;color:#fff}main{flex:1}*{box-sizing:border-box}@media(prefers-color-scheme:dark){html{color-scheme:dark}}.embla__custom_slide{flex:0 0 100%;min-width:0}.embla__viewport{overflow:hidden}.embla__container{display:flex;touch-action:pan-y;margin-left:calc(var(--slide-spacing, 0rem) * -1)}.embla__slide{flex:0 0 100%;min-width:0;padding-left:var(--slide-spacing, 0rem)}img{content-visibility:auto}`,
          }}
        />
        ...
        {/* Async font stylesheet loading - use noscript fallback */}
        <link
          rel="stylesheet"
