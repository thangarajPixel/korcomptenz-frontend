...
export default function LiveDemoList() {
  ...
  const sections = [
    {
      id: "microsoft-dynamics", title: "Microsoft Dynamics",
      items: [
        {
          id: 1,
          title: "Microsoft Dynamics D365 Custom Reporting Analytics (KOR SmartForge)",
          date: "Nov 19, 2025",
          description:
        ...
        },
        {
          ...
          date: "Dec 10, 2025",
          description: "Know Your Customers Like Never Before. Deliver Experiences That Drive Growth.",
        },
        {
          id: 3,
          title: "Revolutionize Accounts Payable with Zero-Touch Finance Powered by Dynamics 365 & AI",
          date: "Nov 13, 2025",
          description:
        ...
        {
          id: 5,
          title: "Unify Your Retail Experience: Seamless Integration of Online & Offline Sales",
          date: "Dec 04, 2025",
          description:
        ...
        {
          id: 6,
          title: "Reimagine Your Warehouse with Intelligent Automation and Voice Picking",
          date: "Dec 11, 2025",
          description:
      ...
      items: [
        {
          ...
          date: "Dec 01, 2025",
          description: "Transform your financial operations with SAP solutions.",
        },
        {
          id: 8,
          title: "End-to-End Digital Project",
          date: "Dec 05, 2025",
          description: "Manage your digital projects end-to-end with integrated SAP solutions.",
        },
        {
          id: 9,
          title: "Transforming Post-MSA",
          date: "Dec 08, 2025",
          description: "Optimize your post-merger integration with SAP best practices.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          title: "Transform Financial",
          date: "Dec 01, 2025",
          description: "Transform your financial operations with Oracle solutions.",
        },
        {
          id: 11,
          title: "End-to-End Digital Project",
          date: "Dec 05, 2025",
          description: "Manage your digital projects end-to-end with integrated Oracle solutions.",
        },
        {
          id: 12,
          title: "Transforming Post-MSA",
          date: "Dec 08, 2025",
          description: "Optimize your post-merger integration with Oracle best practices.",
        },
      ],
    }
  ]
    ...
    const handleScroll = () => {
      ...
      sectionElements.forEach((element) => {
        ...
        if (rect.top <= 150 && rect.bottom > 150) {
          currentActive = element.getAttribute("data-section") || "microsoft-dynamics";
        }
      });
  ...
  const handleSectionClick = (sectionId: string) => {
    ...
    const offset = 100; // distance from top (px)
  ...
  return (
    <div className="relative flex flex-col lg:flex-row bg-white ">
        ...
        <div className="space-y-3 sticky top-32">
          {sections.map((section) => (
            <button
              ...
              className={cn(`w-full text-left font-bold px-4 py-2 text-lg transition-all duration-200  hover:text-primary `,
      ...
      <div ref={contentRef} className="flex-1 overflow-y-auto p-8">
        {/* Content Sections */}
        {sections.map((section) => (
          <div key={section.id} data-section={section.id} className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {section.items.map((item) => (
                ...
                >
                  ...
                  <a href="#" className="text-primary font-semibold text-sm hover:text-primary transition-colors">
                    Book a Demo
                  </a>
                </div>
              ))}
