...
const StretchableSectionCard = ({
  ...
  return (
    <div
      {...rest}
      className={cn(`bg-light-gray rounded-4xl relative overflow-hidden min-h-80 flex flex-row`, props.className)}
      style={{
    ...
    >
      ...
      <div className='pl-8 py-8 lg:pl-10 lg:py-10 flex flex-col gap-3 flex-1 pr-8 relative z-10'>
        <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">{data?.title}</h2>
