  ...
  return (
    <section className="bg-white px-4 sm:px-6 lg:px-8 mb-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-12 gap-4 items-center group">
          {/* Left side - Image with geometric elements */}
          <div className="relative">
            {/* Blue geometric arrows */}
            <div className="absolute top-2 md:top-8 left-2 md:left-6 z-10 group-hover:left-24 transition-all duration-1000">
          ...
          <div className="space-y-8 mx-auto">
            ...
            <div className="relative group-hover:-translate-x-5 group-hover:scale-102 transition-all hidden lg:block">
            ...
            <div className="relative group-hover:-translate-x-5 group-hover:scale-102 transition-all lg:hidden ">
