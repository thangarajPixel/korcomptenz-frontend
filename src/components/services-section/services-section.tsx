        ...
        >
          ...
          >
            {content.map((t) => (
              ...
              >
                <span className="z-50 md:text-3xl  text-xs ">{t.label}</span>
                {value === t.label && (
                  <motion.div
      ...
      <div className="relative container-md  flex flex-col-reverse justify-between items-center gap-4  lg:flex-row">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="space-y-3"
          >
            <h1 className="text-pretty lg:text-6xl text-4xl font-semibold leading-tight text-custom-gray md:text-6xl">
