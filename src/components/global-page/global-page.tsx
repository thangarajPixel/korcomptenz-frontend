  ...
  return data?.map((item, index) => {
    switch (item?.__component) {
      case "home.hero-section-one":
        return (
          <ScrollFadeIn __component={item?.__component} key={`sliding-section-${item?.__component}-${item?.id}`}>
            <SlidingSection key={`sliding-section-${item?.__component}-${item?.id}`} slides={item?.list} />
          </ScrollFadeIn>
        );
      case "page-componets.sticky-cards-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`sticky-cards-${item?.__component}-${item?.id}`}>
            <StickyCards stickyCards={item} />
          </ScrollFadeIn>
        );
      case "page-componets.insights-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`insights-section-${item?.__component}-${item?.id}`}>
            <InsightsSection insights={item} />
          </ScrollFadeIn>
        );
      case "home.opportunity":
        return (
          <ScrollFadeIn __component={item?.__component} key={`opportunity-${item?.__component}-${item?.id}`}>
            <Opportunities careers={item} />
          </ScrollFadeIn>
        );
      case "home.services-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`services-section-${item?.__component}-${item?.id}`}>
            <ServicesSection content={item?.list} />
          </ScrollFadeIn>
        );
      case "page-componets.inspire-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`inspire-section-${item?.__component}-${item?.id}`}>
            <InspireSection inspireSection={item} />
          </ScrollFadeIn>
        );
      case "home.we-are-korcomptenz":
        return (
          <ScrollFadeIn __component={item?.__component} key={`we-are-korcomptenz-${item?.__component}-${item?.id}`}>
            <WeAreKorcomptenzSection weAreKorcomptenzData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.banner-section-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`banner-section-list-${item?.__component}-${item?.id}`}>
      ...
      case "page-componets.sap-section-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`sap-section-${item?.__component}-${item?.id}`}>
            <SapSection sapSectionData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.light-slider-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`light-slider-${item?.__component}-${item?.id}`}>
            <LightSlider data={item} />
          </ScrollFadeIn>
        );
      case "page-componets.sticky-title-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`sticky-title-list-${item?.__component}-${item?.id}`}>
            <StickyTitleList salesforceServices={item} />
          </ScrollFadeIn>
        );
      case "page-componets.dark-slider-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`dark-slider-${item?.__component}-${item?.id}`}>
            <DarkSlider manuelSliderData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.domain-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`domain-section-${item?.__component}-${item?.id}`}>
            <DomainSection domainData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.benefit-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`benefit-section-${item?.__component}-${item?.id}`}>
            <BenefitSection benefitData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.faq-title":
        return (
          <ScrollFadeIn __component={item?.__component} key={`faq-section-${item?.__component}-${item?.id}`}>
            <FaqSection faqData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.demonstrate-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`demonstrate-section-${item?.__component}-${item?.id}`}>
            <DemonstrateSection data={item} />
          </ScrollFadeIn>
        );
      case "page-componets.build-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`build-connect-${item?.__component}-${item?.id}`}>
            <BuildConnect buildData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.tech-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`tech-partner-${item?.__component}-${item?.id}`}>
            <TechPartner techData={item} />
          </ScrollFadeIn>
        );
      case "page-componets.stretchable-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`stretchable-section-${item?.__component}-${item?.id}`}>
            <StretchableSection item={item} />
          </ScrollFadeIn>
        );
      case "case-study.case-study-sticky-cards-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`case-study-sticky-cards-${item?.__component}-${item?.id}`}>
            <CaseStudyStickyCards stickyCards={item} />
          </ScrollFadeIn>
        );
      case "case-study.case-study-domain-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`case-study-domain-section-${item?.__component}-${item?.id}`}>
            <CaseStudyDomainSection domainData={item} />
          </ScrollFadeIn>
        );
      case "home.schedule-call":
        return (
          <ScrollFadeIn __component={item?.__component} key={`schedule-call-${item?.__component}-${item?.id}`}>
      ...
      case "page-componets.why-we-are":
        return (
          <ScrollFadeIn __component={item?.__component} key={`why-we-are-${item?.__component}-${item?.id}`}>
            <WhyKorcomptenz data={item} />
          </ScrollFadeIn>
        );
      case "page-componets.gram-banner":
        return (
          <ScrollFadeIn __component={item?.__component} key={`gram-banner-${item?.__component}-${item?.id}`}>
            <GramBanner gramData={item} />
          </ScrollFadeIn>
        );
      case "form-fields.form":
        return (
          <ScrollFadeIn __component={item?.__component} key={`global-form-${item?.__component}-${item?.id}`}>
            <GlobalForm form={item?.form} />
          </ScrollFadeIn>
        );
      case "case-study.partner-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`partner-section-${item?.__component}-${item?.id}`}>
            <ClientPartnership data={item} />
          </ScrollFadeIn>
        );
      case "about-us.content-showcase-section-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`content-showcase-section-${item?.__component}-${item?.id}`}>
            <ContentShowcaseSection data={item} />
          </ScrollFadeIn>
        );
      case "about-us.map-section-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`map-section-${item?.__component}-${item?.id}`}>
            <MapSection data={item} />
          </ScrollFadeIn>
        );
      case "about-us.our-story-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`our-story-${item?.__component}-${item?.id}`}>
            <OurStory data={item} />
          </ScrollFadeIn>
        );
      case "about-us.people-showcase-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`people-showcase-section-${item?.__component}-${item?.id}`}>
            <PeopleShowcaseSection list={item} />
          </ScrollFadeIn>
        );
      case "about-us.stats-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`stats-section-${item?.__component}-${item?.id}`}>
            <StatsSection data={item} />
          </ScrollFadeIn>
        );
      case "about-us.media-slider-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`media-slider-section-${item?.__component}-${item?.id}`}>
            <MediaSliderSection data={item} />
          </ScrollFadeIn>
        );
      case "career.mansonry-gallery-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`mansonry-gallery-section-${item?.__component}-${item?.id}`}>
            <MasonryGallerySection data={item} />
          </ScrollFadeIn>
        );
      case "about-us.achievement-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`achievement-section-${item?.__component}-${item?.id}`}>
            <AchievementSection data={item} />
          </ScrollFadeIn>
        );
      case "demo-page.demo-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`live-demo-list-${item?.__component}-${item?.id}`}>
      ...
      case "not-found.not-found":
        return (
          <ScrollFadeIn __component={item?.__component} key={`not-found-${item?.__component}-${item?.id}`}>
            <NotFound data={item} />
          </ScrollFadeIn>
        );
      ...
      case "career.open-jobs":
        return (
          <ScrollFadeIn __component={item?.__component} key={`open-jobs-${item?.__component}-${item?.id}`}>
            <OpenJobs data={item} />
          </ScrollFadeIn>
        );
      case "contact-us.news-letter":
        return (
          <ScrollFadeIn __component={item?.__component} key={`contact-us-newsletter-${item?.__component}-${item?.id}`}>
            <ContactUsNewsletter newsletterData={item} />
          </ScrollFadeIn>
        );
      case "contact-us.our-office":
        return (
          <ScrollFadeIn __component={item?.__component} key={`contact-us-office-${item?.__component}-${item?.id}`}>
            <ContactUsOffice officesData={item} />
          </ScrollFadeIn>
        );
      case "contact-us.contact-us-insight-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`contact-us-insights-section-${item?.__component}-${item?.id}`}>
            <ContactUsInsight data={item} />
          </ScrollFadeIn>
        );
      case "contact-us.office-location-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`contact-us-corporate-${item?.__component}-${item?.id}`}>
            <ContactUsCorporate corporateData={item} />
          </ScrollFadeIn>
        );
      case "contact-us.fixed-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`contact-us-fixed-section-${item?.__component}-${item?.id}`}>
            <FixedFooter data={item} />
          </ScrollFadeIn>
        );
      case "contact-us.contact-us-form-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`contact-us-form-${item?.__component}-${item?.id}`}>
            <ContactUsForm data={item} />
          </ScrollFadeIn>
        );
      case "demo-page.demo-partnership":
        return (
          <ScrollFadeIn __component={item?.__component} key={`demo-partnership-${item?.__component}-${item?.id}`}>
            <DemoPartnership data={item} />
          </ScrollFadeIn>
        );
      case "demo-page.experts-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`demo-experts-${item?.__component}-${item?.id}`}>
            <DemoExperts data={item} />
          </ScrollFadeIn>
        );
      case "demo-page.demo-opportunity":
        return (
          <ScrollFadeIn __component={item?.__component} key={`demo-opportunities-${item?.__component}-${item?.id}`}>
            <DemoOpportunities whyAttendData={item} />
          </ScrollFadeIn>
        );
      case "demo-page.demo-demonstration":
        return (
          <ScrollFadeIn __component={item?.__component} key={`demo-demonstration-${item?.__component}-${item?.id}`}>
            <DemoWhyAttend whyAttendData={item} />
          </ScrollFadeIn>
        );
      case "demo-page.build-demo":
        return (
          <ScrollFadeIn __component={item?.__component} key={`build-demo-${item?.__component}-${item?.id}`}>
            <BuildDemo
      ...
      case "page-componets.pricing-section":
        return (
          <ScrollFadeIn __component={item?.__component} key={`pricing-section-${item?.__component}-${item?.id}`}>
            <PricingSection
      ...
      case "kor-cares.kor-care-build-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`kor-care-build-data-${item?.__component}-${item?.id}`}>
            <KorCareBuildData
      ...
      case "kor-cares.impact-description":
        return (
          <ScrollFadeIn __component={item?.__component} key={`impact-description-${item?.__component}-${item?.id}`}>
      ...
      case "kor-cares.award":
        return (
          <ScrollFadeIn __component={item?.__component} key={`kor-care-award-${item?.__component}-${item?.id}`}>
            <KorCareAward
      ...
      case "kor-cares.straight-slider":
        return (
          <ScrollFadeIn __component={item?.__component} key={`kor-care-slider-${item?.__component}-${item?.id}`}>
            <KorCareSlider
      ...
      case "kor-cares.impact-highlight":
        return (
          <ScrollFadeIn __component={item?.__component} key={`kor-care-impact-highlight-${item?.__component}-${item?.id}`}>
      ...
      case "news-and-event.news-description-only":
        return (
          <ScrollFadeIn __component={item?.__component} key={`news-description-only-${item?.__component}-${item?.id}`}>
            <DescriptionOnly
      ...
      case "news-and-event.news-title-description-only":
        return (
          <ScrollFadeIn __component={item?.__component} key={`news-title-description-only-${item?.__component}-${item?.id}`}>
            <TitleDescription
      ...
      case "news-and-event.compounds-newsroom":
        return (
          <ScrollFadeIn __component={item?.__component} key={`compounds-newsroom-${item?.__component}-${item?.id}`}>
            <CombinedSection
      ...
      case "news-and-event.news-service":
        return (
          <ScrollFadeIn __component={item?.__component} key={`news-service-provider-${item?.__component}-${item?.id}`}>
            <ServiceProvider
      ...
      case "news-and-event.color-custom-description":
        return (
          <ScrollFadeIn __component={item?.__component} key={`news-dcolor-custom-description-${item?.__component}-${item?.id}`}>
            <DescriptionOnly
      ...
      case "news-and-event.news-banner":
        return (
          <ScrollFadeIn __component={item?.__component} key={`news-banner-${item?.__component}-${item?.id}`}>
            <VideoBannerSection
      ...
      case "news-and-event.simple-image-gallery":
        return (
          <ScrollFadeIn __component={item?.__component} key={`simple-image-gallery-${item?.__component}-${item?.id}`}>
            <NewsRoomSlider
      ...
      case "news-and-event.testimonal-list":
        return (
          <ScrollFadeIn __component={item?.__component} key={`client-testimonial-${item?.__component}-${item?.id}`}>
            <ClientTestimonial
      ...
      case "news-and-event.build-data":
        return (
          <ScrollFadeIn __component={item?.__component} key={`build-data-${item?.__component}-${item?.id}`}>
            <NewsRoomBuild
