...
const FixedFooter = ({ data }: { data: FixedFooter }) => {
  return (
    <section
      data-debug="contact-us.fixed-section"
      className="fixed inset-x-0 bottom-0 h-32 z-50 bg-primary"
    >
      <div className="flex h-full items-center justify-between container-md">
        <p className="text-4xl text-white line-clamp-2">{data.description}</p>
