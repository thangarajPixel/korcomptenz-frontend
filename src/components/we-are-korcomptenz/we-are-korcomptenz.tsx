      ...
      <div className="grid lg:grid-cols-[1fr_2fr] gap-32 items-start mb-16">
        ...
        <div className="lg:w-full">
          <h1 className="text-2xl lg:text-4xl font-bold leading-tight">
            We are
            <br />
            <span className="text-xl lg:text-3xl">Korcomptenz</span>
          </h1>
        </div>

        {/* Right Column - Description */}
        <div className="space-y-5">
          <p className="font-outfit font-normal text-lg leading-[34px] tracking-[0%] text-pretty whitespace-pre-wrap">
