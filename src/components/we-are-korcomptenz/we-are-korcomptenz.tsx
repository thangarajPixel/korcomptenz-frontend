      ...
      <div className="grid md:grid-cols-[1fr_2fr] gap-10 md:gap-32 items-start mb-10 md:mb-16">
        ...
        <div className="lg:w-full">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            ...
            <br />
            <span className="text-4xl md:text-5xl font-semibold">{weAreKorcomptenzData.titleH2}</span>
          </h1>
        </div>

        {/* Right Column - Description */}
        <div className="space-y-5">
          <p className="font-outfit font-normal text-md md:text-2xl leading-[24px] md:leading-[34px] tracking-[0%] text-pretty ">
