        ...
        {faqData?.faq?.map((item) => (
          ...
          >
            ...
            >
              ...
              <ChevronDownIcon className={cn("size-10 p-2 text-white rounded-full bg-primary pointer-events-none  shrink-0 translate-y-0.5 transition-transform duration-200 opacity-20",
