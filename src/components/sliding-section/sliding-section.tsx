                  ...
                  <div className="absolute inset-0  flex items-start mt-12 md:mt-0 md:items-center">
                    <div className="container-md">
                      <div className="max-w-2xl text-white">
                        <div
                          className={`whitespace-pre-wrap font-bold mb-4 leading-tight text-balance ${slide.subtitle ? "text-2xl md:text-6xl" : "text-lg md:text-5xl font-medium"
                            }`}
                        >
                        ...
                        <h2 className="text-4xl md:text-6xl whitespace-pre-wrap font-semibold mb-4 leading-tight text-balance">
                          {slide.title}
                        </h2>
                        {!slide.description && <div className="h-0 md:h-16 " />}
                        <p className="text-2xl md:text-3xl mb-8 leading-tight  text-pretty">
                          {slide.description}
                        </p>
                        <Button
                          size="xl"
                          variant="white"
                          className="hover:bg-transparent text-2xl md:text-lg hover:text-primary border hover:border-primary"
                          arrow={true}
                        >
                          {slide.buttonText}
                        </Button>
