...
const demonstData ={
   ...
   cards:[
    ...
    },
    {
      ...
      description:"We accelerated this outcome by unifying SAP systems and enabling rapid SLO transition unified three country codes into one platform.",
      buttonText:"Dive Deeper",
      buttonLink:"#Dive Deeper"
    },
    {
      ...
      description:"We streamlined manufacturing and built scalable cloud solutions to help them reduce costs and accelerate growth.",
      buttonText:"Dive Deeper",
      buttonLink:"#Dive Deeper"
    }
   ]
 ...
 <section className="container-md">
      <div className="p-6">
        <div className="flex flex-col gap-9 text-start lg:text-center items-start lg:items-center justify-center leading-14  text-foreground  ">
          ...
          <Button size="xl" arrow={true} className="hidden lg:inline-flex variant:default px-8 py-2 text-4xl rounded-full ">
            {demonstData.buttontext}
          </Button>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:p-10 ">
          {demonstData.cards.map((card, index) => {
            return (
              <section key={index} className={`bg-none flex flex-col gap-4 ${card.type==="even"?"lg:mt-10":""}`}>
        ...
        <Button size="xl" arrow={true} className=" w-full lg:hidden variant:default px-8 py-2 text-4xl rounded-full mt-10">
            {demonstData.buttontext}
          </Button>
      </div>
    </section>
