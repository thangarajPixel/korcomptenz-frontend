  ...
  return (
    <div className="container-md  mt-0 md:mt-16 py-4">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <Card className="border-2 bg-light-gray flex-row py-0 rounded-4xl">
        ...
        <div className="flex flex-col justify-between gap-5 ">
          ...
          <Card className="bg-light-gray p-0 h-full rounded-4xl">
        ...
        <div className="flex flex-col gap-8 justify-between">
          <Card className="bg-light-gray relative rounded-4xl">
            <CardContent className="p-6 text-muted">
...
//         </h1>
//       </div>
//       <Card className="border-2 bg-light-gray flex-row py-3 md:py-0 rounded-4xl">
//         <CardContent className="px-0 flex flex-col justify-between text-muted ">
//           <div className="p-6">
