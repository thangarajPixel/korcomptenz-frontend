  ...
  return (
    <div className="relative inline-block">
      ...
      <Button
        ...
        aria-label="Share"
        className="flex items-center h-10 w-25 justify-center p-1 bg-white border-2 border-teal-500 text-teal-600 rounded-full hover:bg-teal-50 transition-colors duration-200"
      >
