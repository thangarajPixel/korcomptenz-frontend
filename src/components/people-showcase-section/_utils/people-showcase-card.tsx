...
const PeopleShowcaseCard = () => {
  const data = {
    title: "A S Viswanathan",
    description: "He is an industry veteran with over four decades of experience in various leadership roles, board positions and global responsibilities.",
