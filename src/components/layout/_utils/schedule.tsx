      ...
      <div className="container-md">
        <div className="lg:flex flex-row items-center  justify-center lg:gap-8 ">
          ...
          <div className="flex-1 text-center lg:text-left lg:ml-0">
            <h2 className="text-4xl text-left sm:text-6xl lg:text-5xl font-bold text-[#C4D7C9] leading-tight mb-20">
              {footer.scheduleCall.title}
              <br />
              {footer.scheduleCall.highlight}
            </h2>
            <Button size="xl" arrow={true} className="text-2xl hidden lg:inline-flex hover:bg-transparent lg:mt-48" >
          ...
          <Button size="lg" arrow={true} className="text-2xl py-3 lg:hidden hover:bg-transparent lg:mt-48" >
            {footer.scheduleCall.cta}
          </Button>
        </div>
      </div>
