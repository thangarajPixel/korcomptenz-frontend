            ...
            >
              {column?.sections?.map((section) => (
                <div
                  ...
                  className={`relative overflow-hidden rounded-2xl p-6 cursor-pointer transition-all duration-300 items-center border-2 border-primary bg-light-white flex-1 flex ${section.imagePosition === "side" ? "flex-row" : "flex-col"
                    }`}
                >
                  {/* Content Wrapper */}
                  <div
                    className={`flex flex-col ${section?.imagePosition === "side" ? "w-[70%] pr-4" : "w-full"
                      }`}
                  >
                  ...
                  {/* Image */}
                  <div
                    className={`flex items-center justify-center ${section?.imagePosition === "side" ? "w-[40%]" : "w-full mt-4"
                      }`}
                  >
